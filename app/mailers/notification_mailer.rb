class NotificationMailer < ActionMailer::Base
  ...
  def second_reminder(users)
  	mail(:to => users, :subject => "REMINDER: IMPORTANT - Submit your June 2013 Community Awesomeness Awards")
  end

  def third_reminder(users)
  	mail(:to => users, :subject => "FINAL REMINDER: IMPORTANT - Submit your June 2013 Community Awesomeness Awards")
  end
  def test
